...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        # Width and height of the input are preserved, so the feature map after
        # convolutional layer will be of dimension (H, W, num_filters), it then
        # shrinks by a factor of 2 after the 2x2 max-pooling
        self.params['W2'] = weight_scale * np.random.randn(
                H * W * num_filters // (2 * 2), hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        da1 = da1.reshape(a1_original_shape)
